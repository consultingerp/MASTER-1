                    ...
                    if prestashop:
                        ...
                        if type(languages['language']) == list:
                            for row in languages['language']:
                                return_list.append((str(config_id.id)+'-'+row['id'],row['name']+'-'+config_id.name))
                        else:
                            return_list.append((str(config_id.id)+'-'+languages['language']['id'],languages['language']['name']+'-'+config_id.name))
                except:
                    pass
            return return_list
